...
Route::put('/clientes-editar/{id}', [FormularioController::class, 'update'])->name('formulario.update');
Route::get('/cerrarsesion', [FormularioController::class, 'cerrarSesion'])->name('formulario.cerrarSesion');
